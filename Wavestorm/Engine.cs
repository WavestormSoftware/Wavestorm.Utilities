...
public partial class Wavestorm
{
    public class Engine
    {
        ...
        public static Version GetVersion()
        {
            ...
            {
                var version = Utilities.Network.GetPlain("https://wavestormgames.net/api/engine/version/version.php")
                    .ToString();
        ...
        public static bool Download([Optional] string directory)
        {
            try
            {
                ...
                var downloadSuccess = Utilities.Network
                ...
                if (Utilities.Files.ExtractZip(zipFilePath, directory))
                {
                    if (Utilities.Files.DeleteFile(zipFilePath))
                    {
